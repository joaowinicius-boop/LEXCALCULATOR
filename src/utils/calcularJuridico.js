...
export function percentualJuros(juros, termoFinal) {
  ...
  if (juros.tipo === 'taxa_legal') {
    // Lei 14.905/2024: juros legais = SELIC acumulada − IPCA acumulado no período.
    const selic = acumuladoSerie(juros.serieSelic, juros.dataInicio, termoFinal)
    const ipca = acumuladoSerie(juros.serieIpca, juros.dataInicio, termoFinal)
